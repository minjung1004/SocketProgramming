...
import os # Interactiosn with the operating system

class Client:
    # When creating a client, connect to the server, ask for
    # the user's name, and begin server communication.
    ...
    # Send over the name of the client. Then start listening
    ...
    def receive_message(self):
        while True:
            ...
            print("\033[1;34;40m" + server_message + "\033[0m")
